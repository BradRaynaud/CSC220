...
class Node<cade>
{
	...
	public void setData(cade data)
	{
		this.data = data;
	}

	// accessor and mutator for the link component
	public Node<cade> getLink()
	{
		return this.link;
	}

	public void setLink(Node<cade> link)
	{
		this.link = link;
	}
}
...
// the List class
public class List<cade>
{
	public static final int MAX_SIZE = 50;

	private Node<cade> head;
	private Node<cade> tail;
	private Node<cade> curr;
	...
	public void InsertBefore(cade data)
	{
		if (!IsFull())
		{
	...
	// the new element becomes the current
	// this should not be possible for a full list
	public void InsertAfter(cade data)
	{
		if (!IsFull())
		{
			// create a new node and put the appropriate information
			Node<cade> n = new Node();
			n.setData(data);
	...
	public List<cade> Add(List<cade> l)
	{
		...
		List<cade> newList = new List(this);
		Node<cade> n = l.head;
